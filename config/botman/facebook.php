    ...
    */
    'greeting_text' => [
        'greeting' => [
            [
                'locale' => 'default',
                'text' => 'Hello {{user_first_name}} - this is the Build A Chatbot TodoBot!',
            ],
            [
                'locale' => 'en_GB',
                'text' => 'Hello {{user_first_name}} - this is the UK Build A Chatbot TodoBot!',
            ],
        ],
    ],
                ...
                [
                    ...
                    'call_to_actions' => [
                        [
                            'title' => 'My Todos',
                            'type' => 'postback',
                            'payload' => 'show my todos',
                        ],
                        [
                            'title' => 'Add Todo',
                            'type' => 'postback',
                            'payload' => 'add new todo',
                        ],
                    ],
                ],
                [
                    'type' => 'web_url',
                    'title' => 'Powered by BotMan',
                    'url' => 'http://botman.io',
